...
export function GoalCelebration({
  ...
  return (
    <div
      className={`fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm motion-safe:transition-opacity duration-300 ${
    ...
    >
      <div
        className={`relative mx-4 flex w-full max-w-sm flex-col items-center gap-5 rounded-3xl bg-card p-8 shadow-2xl motion-safe:transition-transform duration-500 ${
